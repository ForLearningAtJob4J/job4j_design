...
public class The2DGameWithStandardRulesForTwoOutputStreams {
    ...
    public The2DGameWithStandardRulesForTwoOutputStreams(InputStream input,
                                                         OutputStream output,
                                                         OutputStream2DSquareBoard squareBoard2D,
                                                         OutputStreamPlayer player1,
                                                         OutputStreamPlayer player2,
    ...
    public static void main(String[] args) throws IOException {
        ...
        The2DGameWithStandardRulesForTwoOutputStreams game =
                new The2DGameWithStandardRulesForTwoOutputStreams(
                        System.in,
                        System.out,
                        board,
                        player1,
